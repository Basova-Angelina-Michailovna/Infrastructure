...
public class AddEntityCommand(IDbContextFactory<DataModelContext> dbFactory) : ICommand<AddEntityCommandContext, AddEntityCommandResult>
{
    public async Task<AddEntityCommandResult> ExecuteAsync(AddEntityCommandContext context, CancellationToken token = default)
    {
